      ...
      <div className="left_container">
        ...
        <form action="/form/submit" method="get">
          ...
          <input
            type="type"
            className="text"
            placeholder="Not sure what type of healthcare provider you need? Provide a short description of your symptoms and we will help you find the righ doctor for you."
          />
          <br />
          <br />
